...
| —    |        |                       | _Auto-route: báo cáo tự động vào Department queue theo ProvinceCode_ |               |
...
| —    |        |                           | _Auto-close: hệ thống tự đóng sau 7 ngày nếu Citizen không phản hồi_ | `Resolved → Closed`     |
