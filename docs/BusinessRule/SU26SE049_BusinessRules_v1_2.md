...
| BR-GAM-004 | Huy hiệu (Badges) | 'First Report', 'Eco Warrior (10 reports)', 'Hotspot Hunter (3 reports trong hotspot)', 'Verified Citizen (xác thực CCCD)', 'Streak (7 ngày liên tiếp)'. Admin thêm badge (BR-ADM-005). | Business Rule | N/A |
