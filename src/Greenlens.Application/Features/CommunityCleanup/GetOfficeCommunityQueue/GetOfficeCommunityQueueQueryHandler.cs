...
public sealed class GetOfficeCommunityQueueQueryHandler(
    ICommunityCleanupEventRepository events,
    IUserRepository users,
    ICurrentUser currentUser,
    ILogger<GetOfficeCommunityQueueQueryHandler> logger)
    : IRequestHandler<GetOfficeCommunityQueueQuery, Result<CommunityCleanupListResponse>>
{
    ...
    public async Task<Result<CommunityCleanupListResponse>> Handle(GetOfficeCommunityQueueQuery request, CancellationToken ct)
    {
