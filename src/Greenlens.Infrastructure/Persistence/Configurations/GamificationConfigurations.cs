    ...
    public void Configure(EntityTypeBuilder<Badge> builder)
    {
        ...
        // Seed initial badges (BR-GAM-004) — 13 badges, 4 groups
            ...
            builder.HasData(
                ...
                new { Id = Guid.Parse("a1000001-0000-0000-0000-000000000001"), Code = "first_report", NameVi = "Người Khởi Đầu", NameEn = "First Reporter", Description = "Gửi báo cáo ô nhiễm đầu tiên được xác minh", IsActive = true, RequiredReportCount = (int?)1, RequiredPoints = (int?)null, RequiredStreakDays = (int?)null, IconUrl = (string?)"badges/icons/first_report.png", CreatedAt = seedDate },
                new { Id = Guid.Parse("a1000001-0000-0000-0000-000000000002"), Code = "eco_warrior", NameVi = "Chiến Binh Xanh", NameEn = "Eco Warrior", Description = "Gửi 10 báo cáo ô nhiễm được xác minh", IsActive = true, RequiredReportCount = (int?)10, RequiredPoints = (int?)null, RequiredStreakDays = (int?)null, IconUrl = (string?)"badges/icons/eco_warrior.png", CreatedAt = seedDate },
                new { Id = Guid.Parse("a1000001-0000-0000-0000-000000000003"), Code = "green_champion", NameVi = "Nhà Vô Địch Xanh", NameEn = "Green Champion", Description = "Gửi 50 báo cáo ô nhiễm được xác minh", IsActive = true, RequiredReportCount = (int?)50, RequiredPoints = (int?)null, RequiredStreakDays = (int?)null, IconUrl = (string?)"badges/icons/green_champion.png", CreatedAt = seedDate },
                new { Id = Guid.Parse("a1000001-0000-0000-0000-000000000004"), Code = "earth_guardian", NameVi = "Người Bảo Vệ Trái Đất", NameEn = "Earth Guardian", Description = "Gửi 100 báo cáo ô nhiễm được xác minh", IsActive = true, RequiredReportCount = (int?)100, RequiredPoints = (int?)null, RequiredStreakDays = (int?)null, IconUrl = (string?)"badges/icons/earth_guardian.png", CreatedAt = seedDate },

                // ── Group B: Streak (consecutive days) ──
                new { Id = Guid.Parse("a1000001-0000-0000-0000-000000000005"), Code = "streak_7d", NameVi = "Bền Bỉ 7 Ngày", NameEn = "7-Day Streak", Description = "Gửi báo cáo 7 ngày liên tiếp", IsActive = true, RequiredReportCount = (int?)null, RequiredPoints = (int?)null, RequiredStreakDays = (int?)7, IconUrl = (string?)"badges/icons/streak_7d.png", CreatedAt = seedDate },
                new { Id = Guid.Parse("a1000001-0000-0000-0000-000000000006"), Code = "streak_30d", NameVi = "Kiên Trì 30 Ngày", NameEn = "30-Day Streak", Description = "Gửi báo cáo 30 ngày liên tiếp", IsActive = true, RequiredReportCount = (int?)null, RequiredPoints = (int?)null, RequiredStreakDays = (int?)30, IconUrl = (string?)"badges/icons/streak_30d.png", CreatedAt = seedDate },
                ...
                new { Id = Guid.Parse("a1000001-0000-0000-0000-000000000011"), Code = "eco_expert", NameVi = "Chuyên Gia Môi Trường", NameEn = "Eco Expert", Description = "Đạt Level 4 với 1.500 điểm tích lũy", IsActive = true, RequiredReportCount = (int?)null, RequiredPoints = (int?)1500, RequiredStreakDays = (int?)null, IconUrl = (string?)"badges/icons/eco_expert.png", CreatedAt = seedDate },
                new { Id = Guid.Parse("a1000001-0000-0000-0000-000000000012"), Code = "green_legend", NameVi = "Huyền Thoại Xanh", NameEn = "Green Legend", Description = "Đạt Level 5 với 5.000 điểm tích lũy — thành tựu cao nhất", IsActive = true, RequiredReportCount = (int?)null, RequiredPoints = (int?)5000, RequiredStreakDays = (int?)null, IconUrl = (string?)"badges/icons/green_legend.png", CreatedAt = seedDate }
            );
    }
}
