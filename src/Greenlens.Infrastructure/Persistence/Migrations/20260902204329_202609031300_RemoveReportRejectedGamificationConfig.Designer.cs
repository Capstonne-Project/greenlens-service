...
namespace Greenlens.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260902204329_202609031300_RemoveReportRejectedGamificationConfig")]
    partial class _202609031300_RemoveReportRejectedGamificationConfig
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Greenlens.Domain.Entities.CommunityCleanupEvent", b =>
                {
                    ...
                    b.Property<DateTime?>("FacebookPageSharedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("facebook_page_shared_at");
            ...
            modelBuilder.Entity("Greenlens.Domain.Entities.GamificationConfig", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            ActionType = "CommunityCleanupParticipation",
                            CreatedAt = new DateTime(2026, 7, 10, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Tham gia và check-in một chương trình dọn dẹp cộng đồng đã hoàn thành",
                            IsActive = true,
                            Points = 15
                        });
                });
